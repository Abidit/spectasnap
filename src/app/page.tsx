  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* ── RIGHT: Product info (tablet sidebar, light) ── */}
        <aside
      ...
      {/* ── Mobile: frame name below camera (no price) ── */}
